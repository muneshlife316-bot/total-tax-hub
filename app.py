...
app.config['SECRET_KEY'] = 'totaltaxhub_secret_key_2025'
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres.peseegldtfjujkwxdmdg:Kanishk%409257@aws-1-ap-northeast-2.pooler.supabase.com:6543/postgres"
